...
"""
CV2-based transformation functions for image and multimodal (image + text) processing.

This module provides image transformation utilities with support for multimodal
(image + text) operations for open vocabulary detection.
"""
