...
_C.DATA.AUTO_SYNC_CLASS_COUNTS = True
...
_C.MODEL.BACKBONE.TORCHVISION_NAME = "auto"
_C.MODEL.BACKBONE.VISUAL_PRETRAINED = False
_C.MODEL.BACKBONE.FREEZE_PRETRAINED_VISUAL = False
_C.MODEL.BACKBONE.FREEZE_PRETRAINED_TEXT = False
...
_C.MODEL.STM.DESCRIPTION_ALIGNMENT = False
_C.MODEL.STM.DESCRIPTION_ALIGNMENT_WEIGHT = 0.15
_C.MODEL.STM.DESCRIPTION_ALIGNMENT_MARGIN = 0.10
_C.MODEL.STM.DESCRIPTION_ALIGNMENT_USE_CATEGORY = True
...
_C.SOLVER.EVAL_AFTER = 1
_C.SOLVER.PROGRESS_BAR = True
_C.SOLVER.LOG_ITERATION_UPDATES = False
_C.SOLVER.LOG_ITERATION_EVERY = 20
