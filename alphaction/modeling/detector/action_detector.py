...
class ActionDetector(nn.Module):
    ...
    def forward(self, primary_inputs, secondary_inputs, boxes, objects=None, extras={}, part_forward=-1):
        ...
        if part_forward==1:
            ...
            slow_features, fast_features = self.backbone(primary_inputs, secondary_inputs)
